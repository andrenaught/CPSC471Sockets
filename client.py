...
while (ans != "quit"):
	...
	if command == "put" and ftp_arg_count == 1:
		...
		#NOTE: not sure how buffer works so just used bufferSize for the recieves -andre

		primarySocket.send(ans)
		print("sending ls request to server")

		#get ephemeral port generated by server
		ephPort = primarySocket.recv(bufferSize)
		print ("Ephermeral port # ",ephPort)

		#create ephemeral socket and wait for data
		ephSocket = createSocket(ephPort)
		data = ephSocket.recv(bufferSize)
